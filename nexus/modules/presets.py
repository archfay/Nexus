...
PRESETS = {
    "fun": [
        ...
        "https://mods.DoNotWeb.life/randnum.py",
        "https://mods.DoNotWeb.life/loli.py",
        "https://mods.DoNotWeb.life/DoxTool.py",
        "https://mods.DoNotWeb.life/randomizer.py",
    ],
    "chat": [
        ...
        "https://mods.DoNotWeb.life/id.py",
        "https://mods.DoNotWeb.life/clickon.py",
        "https://mods.DoNotWeb.life/autoclicker.py",
    ...
    "service": [
        ...
        "https://github.com/amm1edev/ame_repo/raw/refs/heads/main/swmute.py",
        "https://mods.DoNotWeb.life/modlist.py",
    ],
    "downloaders": [
...
class Presets(loader.Module):
    """Suggests new Nexus users a packs of modules to load"""
