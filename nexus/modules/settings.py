...
class CoreMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                ...
                False,
                (
                    "Allow DoNotWeb.t.me to control the actions of your userbot"
    ...
    @loader.command(
        ru_doc="Информация о Nexus",
        en_doc="Information of Nexus",
        ua_doc="Інформація про Nexus",
        de_doc="Informationen über Nexus",
    )
    async def nexuscmd(self, message: Message):
        await utils.answer(
            message,
            self.strings("nexus").format(
                (
    ...
    async def setprefix(self, message: Message):
        ...
        if len(args) == 2:
            ...
            tsec_users = [
                rule["target"] for rule in self._client.dispatcher.security._tsec_user
            ]
