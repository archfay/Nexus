...
"""
Minimal stub for WebDebugger removed for security.
This stub keeps the public API so other modules won't fail,
but disables interactive debugger functionality.
"""
