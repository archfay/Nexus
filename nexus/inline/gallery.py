    ...
    async def gallery(
        ...
        *,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Nexus will try to determine the filetype of these images
        :param manual_security: By default, Nexus will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Nexus will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _nexus_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
        ...
        for unit in self._units.copy().values():
            if (
                ...
                try:
                    ...
                    args = {
                        "thumbnail_url": (
                            "https://img.icons8.com/fluency/344/loading.png"
                        ),
